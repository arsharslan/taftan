...
export default function Autocomplete({
    ...
    return <input
        ...
        {...registerValue}
        name={name}
        className="block w-full bg-transparent text-white rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
        ref={(e) => {
            registerValue.ref(e);
            pinRef.current = e
          }}
