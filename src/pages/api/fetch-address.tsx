...
export async function GET(req: NextApiRequest, res: NextApiResponse<ResponseData | AddressResponse>) {
    try {
...
export default async function handler(req: NextApiRequest, res: NextApiResponse<ResponseData | AddressResponse>) {
